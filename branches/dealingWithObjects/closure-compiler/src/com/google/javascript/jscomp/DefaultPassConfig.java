...
public class DefaultPassConfig extends PassConfig {
  ...
  protected List<PassFactory> getOptimizations() {
    ...
    // This goes before markUnnormalized so that we instrument normalized code
    if (options.symbolicExecutionInstrumentation) {
      passes.add(symbolicExecutionInstrumentation);
    }
  ...
  /** Adds instrumentations to enable symbolic execution. */
  private final PassFactory symbolicExecutionInstrumentation =
      new PassFactory("symbolicExecutionInstrumentation", true) {
    @Override
    protected CompilerPass createInternal(final AbstractCompiler compiler) {
